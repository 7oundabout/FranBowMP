...
class mainrun():
	...
	def main(self):
		...
		p[0][0] = players[p[0][6]].rect.x ; p[0][1] = players[p[0][6]].rect.y ; p[0][2] = players[p[0][6]].direction ; p[0][3] = players[p[0][6]].detector ; p[0][4] = players[p[0][6]].index ; p[0][5] = players[p[0][6]].level ; p[0][7] = players[p[0][6]].package ; p[0][8] = None #передача измененной локалки p на сервер
