...
backgrounds = [pygame.image.load('backgrounds/1.png'), pygame.image.load('backgrounds/2.png'), pygame.image.load('backgrounds/3.png'), pygame.image.load('backgrounds/4.png'), pygame.image.load('backgrounds/5.png'), pygame.image.load('backgrounds/6.png')]
platform_texture = pygame.image.load('sprites/objects/platform.png')
ico_game = pygame.image.load('sprites/ico_game.bmp')
